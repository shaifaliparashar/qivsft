...
for i=1:size(Pest,2)
    ...
    M2i=M2((i-1)*3 + 1:(i)*3,:);
    % dPde(1,1)
    Jii=[2*(M2i(1,:)*x(:,1))*M2i(1,:),2*(M2i(1,:)*x(:,2))*M2i(1,:),2*(M2i(1,:)*x(:,3))*M2i(1,:)]./sqrt(abs(dPe(1))+eps);
    % dPde(1,2)
    Jii=[Jii;[(M2i(1,:)*x(:,1))*M2i(2,:)+(M2i(2,:)*x(:,1))*M2i(1,:),(M2i(1,:)*x(:,2))*M2i(2,:)+(M2i(2,:)*x(:,2))*M2i(1,:),(M2i(1,:)*x(:,3))*M2i(2,:)+(M2i(2,:)*x(:,3))*M2i(1,:)]./sqrt(abs(dPe(2))+eps)];
     % dPde(1,3)
    Jii=[Jii;[(M2i(1,:)*x(:,1))*M2i(3,:)+(M2i(3,:)*x(:,1))*M2i(1,:),(M2i(1,:)*x(:,2))*M2i(3,:)+(M2i(3,:)*x(:,2))*M2i(1,:),(M2i(1,:)*x(:,3))*M2i(3,:)+(M2i(3,:)*x(:,3))*M2i(1,:)]./sqrt(abs(dPe(3))+eps)];
     % dPde(2,2)
    Jii=[Jii;[(M2i(2,:)*x(:,1))*M2i(2,:)+(M2i(2,:)*x(:,1))*M2i(2,:),(M2i(2,:)*x(:,2))*M2i(2,:)+(M2i(2,:)*x(:,2))*M2i(2,:),(M2i(2,:)*x(:,3))*M2i(2,:)+(M2i(2,:)*x(:,3))*M2i(2,:)]./sqrt(abs(dPe(4))+eps)];    
     % dPde(2,3)
    Jii=[Jii;[(M2i(2,:)*x(:,1))*M2i(3,:)+(M2i(3,:)*x(:,1))*M2i(2,:),(M2i(2,:)*x(:,2))*M2i(3,:)+(M2i(3,:)*x(:,2))*M2i(2,:),(M2i(2,:)*x(:,3))*M2i(3,:)+(M2i(3,:)*x(:,3))*M2i(2,:)]./sqrt(abs(dPe(5))+eps)];    
     % dPde(3,3)
    Jii=[Jii;[(M2i(3,:)*x(:,1))*M2i(3,:)+(M2i(3,:)*x(:,1))*M2i(3,:),(M2i(3,:)*x(:,2))*M2i(3,:)+(M2i(3,:)*x(:,2))*M2i(3,:),(M2i(3,:)*x(:,3))*M2i(3,:)+(M2i(3,:)*x(:,3))*M2i(3,:)]./sqrt(abs(dPe(6))+eps)];    
    Ji=[Ji;Jii];
    %triangular
