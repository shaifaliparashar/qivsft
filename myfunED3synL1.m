...
for i=1:size(Pest,2)
    ...
    M2i=M2((i-1)*3 + 1:(i)*3,:);
    % dPde(1,1)
    Jii=sign(dPe1(1,1))*[2*(M2i(1,:)*x(:,1))*M2i(1,:),2*(M2i(1,:)*x(:,2))*M2i(1,:),2*(M2i(1,:)*x(:,3))*M2i(1,:)];
    % dPde(1,2)
    Jii=[Jii;sign(dPe1(1,2))*[(M2i(1,:)*x(:,1))*M2i(2,:)+(M2i(2,:)*x(:,1))*M2i(1,:),(M2i(1,:)*x(:,2))*M2i(2,:)+(M2i(2,:)*x(:,2))*M2i(1,:),(M2i(1,:)*x(:,3))*M2i(2,:)+(M2i(2,:)*x(:,3))*M2i(1,:)]];
     % dPde(1,3)
    Jii=[Jii;sign(dPe1(1,3))*[(M2i(1,:)*x(:,1))*M2i(3,:)+(M2i(3,:)*x(:,1))*M2i(1,:),(M2i(1,:)*x(:,2))*M2i(3,:)+(M2i(3,:)*x(:,2))*M2i(1,:),(M2i(1,:)*x(:,3))*M2i(3,:)+(M2i(3,:)*x(:,3))*M2i(1,:)]];
     % dPde(2,2)
    Jii=[Jii;sign(dPe1(2,2))*[(M2i(2,:)*x(:,1))*M2i(2,:)+(M2i(2,:)*x(:,1))*M2i(2,:),(M2i(2,:)*x(:,2))*M2i(2,:)+(M2i(2,:)*x(:,2))*M2i(2,:),(M2i(2,:)*x(:,3))*M2i(2,:)+(M2i(2,:)*x(:,3))*M2i(2,:)]];    
     % dPde(2,3)
    Jii=[Jii;sign(dPe1(2,3))*[(M2i(2,:)*x(:,1))*M2i(3,:)+(M2i(3,:)*x(:,1))*M2i(2,:),(M2i(2,:)*x(:,2))*M2i(3,:)+(M2i(3,:)*x(:,2))*M2i(2,:),(M2i(2,:)*x(:,3))*M2i(3,:)+(M2i(3,:)*x(:,3))*M2i(2,:)]];    
     % dPde(3,3)
    Jii=[Jii;sign(dPe1(3,3))*[(M2i(3,:)*x(:,1))*M2i(3,:)+(M2i(3,:)*x(:,1))*M2i(3,:),(M2i(3,:)*x(:,2))*M2i(3,:)+(M2i(3,:)*x(:,2))*M2i(3,:),(M2i(3,:)*x(:,3))*M2i(3,:)+(M2i(3,:)*x(:,3))*M2i(3,:)]];    
